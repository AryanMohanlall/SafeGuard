...
public abstract class SafeGuardWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static SafeGuardWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(SafeGuardWebHostModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<SafeGuardDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<SafeGuardDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<SafeGuardDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<SafeGuardDbContext, Task<T>> func)
    {
        T result;
